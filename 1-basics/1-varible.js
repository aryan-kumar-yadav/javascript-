...
console.log("riya")
console.log("rahaual")
/* here console.log()is used to show as a output written in bracket*/
const accountId =7999
...
let accountState
// varible with no valuewill be considered undefined 
console.log(accountId);
//prefer nort use var instead use let 
